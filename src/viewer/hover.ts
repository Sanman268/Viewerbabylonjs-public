...
import "@babylonjs/core/Layers/effectLayerSceneComponent"; // side-effect: HighlightLayer scene component
import "@babylonjs/core/Culling/ray"; // side-effect: enables scene.pick ray casting
